        ...
        >
          <Container maxWidth="lg">
            ...
            <Typography
              ...
              paragraph
            >
              Click on each customer to see detailed information
            </Typography>
          </Container>
        </Box>
        <Container sx={{ py: 8 }} maxWidth="lg">
          <Grid container spacing={4}>
            {customers.map((c: CustomerData, idx: number) => (
              <Grid item key={idx} xs={12} sm={6} md={4}>
                ...
                >
                  <CardContent sx={{ flexGrow: 1 }}>
                    ...
                    <Typography>Total Spent: ${c.total}</Typography>
                  </CardContent>
                  <CardActions>
                    <Button size="small">
                      <Link to={`/customers/${c.customerName}`}>Details</Link>
                    </Button>
                  </CardActions>
                </Card>
              </Grid>
